...
from backend.ubiquiti.devices import DEVICES, Device
from backend.ubiquiti.lock import DEFAULT_RULESET, DeviceLocker, LockOptions
...
def test_lock_owner_uses_devices_by_owner(monkeypatch):
    ...
    monkeypatch.setattr("backend.ubiquiti.lock.get_device_repository", lambda: Repo())
