...
from .devices import Device, devices_by_owner
...
class DeviceLocker:
    ...
    def lock_owner(self, owner: str) -> Iterable[Mapping[str, object]]:
        ...
        return self.lock_devices(devices_by_owner(owner))
    ...
    def unlock_owner(self, owner: str) -> int:
        ...
        return self.unlock_devices(devices_by_owner(owner))
    ...
    def _next_rule_index(rules: Iterable[Mapping[str, object]]) -> int:
        ...
        for rule in rules:
            try:
                value = int(rule.get("rule_index", 0))
